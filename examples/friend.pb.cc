...
// source: examples/friend.proto

#include "examples/friend.pb.h"
...
static ::_pb::Metadata file_level_metadata_examples_2ffriend_2eproto[3];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_examples_2ffriend_2eproto = nullptr;
static const ::_pb::ServiceDescriptor* file_level_service_descriptors_examples_2ffriend_2eproto[1];

const uint32_t TableStruct_examples_2ffriend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_examples_2ffriend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\025examples/friend.proto\022\006fixbug\"-\n\nResul"
  ...
  "\n\020FriendServiceRpc\022O\n\016GetFriendsList\022\035.f"
  "ixbug.GetFriendsListRequest\032\036.fixbug.Get"
  "FriendsListResponseB\003\200\001\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_examples_2ffriend_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_examples_2ffriend_2eproto = {
    false, false, 312, descriptor_table_protodef_examples_2ffriend_2eproto,
    "examples/friend.proto",
    &descriptor_table_examples_2ffriend_2eproto_once, nullptr, 0, 3,
    schemas, file_default_instances, TableStruct_examples_2ffriend_2eproto::offsets,
    file_level_metadata_examples_2ffriend_2eproto, file_level_enum_descriptors_examples_2ffriend_2eproto,
    file_level_service_descriptors_examples_2ffriend_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_examples_2ffriend_2eproto_getter() {
  return &descriptor_table_examples_2ffriend_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_examples_2ffriend_2eproto(&descriptor_table_examples_2ffriend_2eproto);
namespace fixbug {
...
::PROTOBUF_NAMESPACE_ID::Metadata ResultCode::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_examples_2ffriend_2eproto_getter, &descriptor_table_examples_2ffriend_2eproto_once,
      file_level_metadata_examples_2ffriend_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendsListRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_examples_2ffriend_2eproto_getter, &descriptor_table_examples_2ffriend_2eproto_once,
      file_level_metadata_examples_2ffriend_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendsListResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_examples_2ffriend_2eproto_getter, &descriptor_table_examples_2ffriend_2eproto_once,
      file_level_metadata_examples_2ffriend_2eproto[2]);
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendServiceRpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_examples_2ffriend_2eproto);
  return file_level_service_descriptors_examples_2ffriend_2eproto[0];
}
...
void FriendServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_examples_2ffriend_2eproto[0]);
  switch(method->index()) {
    case 0:
